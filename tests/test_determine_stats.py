...
class TestDetermineStats(TestCase):
    def test_determine_stats_mage(self):
        test_char_one = {'Name': 'RAK', 'Class': 'Mage', 'Attack': None, 'Spell': 'Doomsday', 'MP Cost': None,
                         'X-coord': 0, 'Y-coord': 0, 'Z-coord': 0, 'HP': 100, 'MP': 100, 'EXP': 0, 'Level': 1,
                         'Turn': False, 'Affliction': None}
        determine_stats(test_char_one)
        expected = {'Name': 'RAK', 'Class': 'Mage', 'Attack': 35, 'Spell': 'Doomsday', 'MP Cost': None,
    ...
    def test_determine_stats_warrior(self):
        test_char_two = {'Name': 'Bob', 'Class': 'Warrior', 'Attack': None, 'Spell': 'Earthquake Chain',
        ...
        expected = {'Name': 'Bob', 'Class': 'Warrior', 'Attack': 50, 'Spell': 'Earthquake Chain',
    ...
    def test_determine_stats_thief(self):
        test_char_three = {'Name': 'Teef', 'Class': 'Thief', 'Attack': None, 'Spell': 'Stab', 'MP Cost': None,
                           'X-coord': 0, 'Y-coord': 0, 'Z-coord': 0, 'HP': 100, 'MP': 100, 'EXP': 0, 'Level': 1,
                           'Turn': False, 'Affliction': None}
        determine_stats(test_char_three)
        expected = {'Name': 'Teef', 'Class': 'Thief', 'Attack': 60, 'Spell': 'Stab', 'MP Cost': None,
                    'X-coord': 0, 'Y-coord': 0, 'Z-coord': 0, 'HP': 100, 'MP': 100, 'EXP': 0, 'Level': 1,
                    'Turn': False, 'Affliction': None}
